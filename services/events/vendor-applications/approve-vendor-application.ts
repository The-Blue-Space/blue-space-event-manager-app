...
export async function production(params: Parameters): Promise<Response> {
	...
	const response = await axios.put(`/v1/events/${event_id}/vendor-applications/${id}/approve`, data);
...
export default async function approveVendorApplication(params: Parameters): Promise<Response> {
