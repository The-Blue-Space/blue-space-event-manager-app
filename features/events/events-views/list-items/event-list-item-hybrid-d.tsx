...
type EventListItemHybridDProps = {
	event: Event;
};

/**
 * Hybrid D: Floating Date Badge
 * Date badge overlaid on card, thumbnail inside card aligned with title
 */
export default React.memo(function EventListItemHybridD({ event }: EventListItemHybridDProps) {
	...
	return (
		<div className="relative border border-neutral-200 rounded-lg hover:border-neutral-300 hover:shadow-md transition-all bg-white group">
			{/* Floating Date Badge */}
			<div className="absolute left-3 top-3 z-10">
				{dateInfo ? (
					<div className="bg-primary-500 text-white rounded-lg p-2 shadow-md min-w-[56px] text-center">
						<div className="text-xs font-medium opacity-90">{dateInfo.month}</div>
						<div className="text-2xl font-bold leading-none my-0.5">{dateInfo.day}</div>
			...
			{/* Main Content */}
			<div className="flex items-start gap-3 p-3 pl-24">
				{/* Thumbnail - aligned with title */}
