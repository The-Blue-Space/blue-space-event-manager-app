						...
						>
							<TableCell>
								<div className="flex flex-col">
									<h6 className="font-medium text-xs text-neutral-900">{truncate(item.id, 12)}</h6>
							...
							<TableCell>
								<div className="flex flex-col">
									{/* <span className="text-xs font-medium text-neutral-900">{customerName}</span> */}
									{customerUsername && (
										<span className="text-xs text-neutral-500">@{customerUsername}</span>
									)}
								</div>
							</TableCell>
							...
							<TableCell>
								<span className="text-xs text-neutral-600">{item.payment_method || "N/A"}</span>
							</TableCell>

							<TableCell>
								<Badge
									className={classNames(
										"text-xs flex items-center gap-1 w-fit border",
							...
							<TableCell>
								{paidAt ? (
									<div className="flex flex-col">
										<span className="text-xs text-neutral-700">{paidAt.date}</span>
										<span className="text-xs text-neutral-500">{paidAt.time}</span>
									</div>
								) : (
