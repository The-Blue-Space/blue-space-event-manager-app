	...
	return (
		<div className="space-y-3">
			...
			<div className="bg-neutral-50 rounded-lg p-4 space-y-3">
				{Object.entries(info).filter((item) => item[1] !== undefined && item[1] !== null).map(([key, value]) => (
...
// 	<span className="body-3 text-neutral-600">Order ID</span>
// 	<span className="body-3 font-mono font-medium text-neutral-900">{order.id}</span>
// </div>
// {order.payment_reference && (
// 	<div className="flex items-center justify-between">
// 		<span className="body-3 text-neutral-600">Payment Reference</span>
// 		<span className="body-3 font-mono font-medium text-neutral-900">
// 			{order.payment_reference}
// 		</span>
// 	</div>
// )}
// <div className="flex items-center justify-between">
// 	<span className="body-3 text-neutral-600">Payment Status</span>
// 	<Badge
// 		className={classNames("body-3 flex items-center gap-1 border", statusConfig.className)}
// 	>
// 		{statusConfig.icon}
...
// 	<div className="flex items-center justify-between">
// 		<span className="body-3 text-neutral-600">Payment Method</span>
// 		<span className="body-3 font-medium text-neutral-900">{order.payment_method}</span>
// 	</div>
// )}
