	...
	return (
		<div className="max-w-2xl mx-auto space-y-6">
			<div className="space-y-2">
				<h2 className="text-xl font-semibold text-neutral-900">Manager Profile</h2>
				<p className="body-3 text-neutral-600">
					Update your manager profile information. This information will be displayed on your events
					and public profile.
				</p>
			</div>
